<footer>
  <div class="container">
    <div class="logo">
      <a href=""><img src="images/logo.jpg" style="width: 20%;" alt=""></a>
    ...
    <div class="link">
      <!-- <div class="col">
        <a href="">Về Frap Food</a>
        <a href="">Về Grap</a>
        <a href="https://dangthanh.site">Blogs</a>
      </div> -->
      <div class="col">
        <!-- <a href="">Mở quán trên Grap Food</a> -->
        <a href="">Trở thành tài xế The Mansion House</a>
      </div>
      <div class="col">
      ...
      <div class="icon">
        <a href="https://www.facebook.com/profile.php?id=100064024931326"><i class="fab fa-facebook-square"></i></a>
